...
export default function CreatorModal({ isOpen, onClose }: CreatorModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="relative max-w-2xl rounded-2xl bg-white p-8 shadow-xl dark:bg-gray-800">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="text-center">
            <h2 className="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Aditya Kumar</h2>
          ...
          <div className="prose max-w-none text-center dark:prose-invert">
            <p className="text-gray-600 dark:text-gray-300">
              Hi there! I'm Aditya, a passionate developer who loves creating tools that make learning easier.
              StudyMate is my contribution to help students organize their study materials effectively.
            </p>
          </div>
          ...
          <div className="flex space-x-4">
            ...
            <a
              href="https://www.linkedin.com/in/aditya0545/"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full bg-gray-100 p-2 text-gray-600 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
            >
